...
<nav class="navbar navbar-expand-lg navbar-dark site_navbar bg-dark site-navbar-light" id="site-navbar">
    <div class="container">
        <a class="navbar-brand" href="index.html">WielkaSzama</a>
        ...
        <div class="collapse navbar-collapse" id="site-nav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item"><a href="#section-offer" class="nav-link">Menu Sezonowe</a></li>
...
<section class="site-cover" style="background-image: url(front/images/bg_3.jpg);" id="section-home">
    <div class="container">
        <div class="row align-items-center justify-content-center text-center site-vh-100">
            <div class="col-md-12">
                <h1 class="site-heading site-animate mb-3">Witamy na stronie restauracji Wielka Szama</h1>
                <h2 class="h5 site-subheading mb-5 site-animate">Oferujemy szerokie spektrum wyboru dań mięsnych jak i dla wegetarian. Każdy w naszej restauracji znajdzie coś dla siebie. Zapraszamy do przyjścia i spróbowania.</h2>
                <p><a href="https://colorlib.com/" target="_blank" class="btn btn-outline-white btn-lg site-animate" data-toggle="modal" data-target="#reservationModal">Rezerwacja</a></p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 site-animate img" data-animate-effect="fadeInRight">
                <img src="front/images/about_img_1.jpg" alt="Free Template by colorlib.com" class="img-fluid">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12 text-center mb-5 site-animate">
                ...
                <h2 class="display-4">Menu sezonowe </h2>
                <div class="row justify-content-center">
                    <div class="col-md-7">
                        <p class="lead">Znajduje się tutaj specjalne menu sezonowe które nie znajduje się w karcie. Jest ono oparte o świeże sezonowe produkty które dostepne są o określonej porze roku</p>
                    </div>
                </div>
            </div>
            <div class="col-md-12">
                    ...
                    <?php $__currentLoopData = $sliders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$slider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="item">
                            <div class="media d-block mb-4 text-center site-media site-animate border-0">
                                <img src="<?php echo e(asset('uploads/slider/'.$slider->image)); ?>" alt="lobrazekjakistam" class="img-fluid" style="height: 400px; width: 400px;">
                                <div class="media-body p-md-5 p-4">
                                    <h5 class="text-primary"><?php echo e($slider->price); ?> zł</h5>
                                    <h5 class="mt-0 h4"><?php echo e($slider->title); ?></h5>
                                    <p class="mb-4" ><?php echo e($slider->sub_title); ?></p>
...
<section class="site-section" id="section-menu">
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center mb-5 site-animate">
                <h2 class="display-4">Delicious menu w pizdziec od Magdy Gessler</h2>
                <div class="row justify-content-center">
                    <div class="col-md-7">
                        <p class="lead">Kurwa i chuj</p>
                    </div>
                </div>
            </div>
                ...
                <ul class="nav site-tab-nav nav-pills mb-5" id="pills-tab" role="tablist">
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="nav-item site-animate">
                            <a class="nav-link active" id="pills-<?php echo e($category->slug); ?>-tab" data-toggle="pill" href="#pills-<?php echo e($category->slug); ?>" role="tab" aria-controls="pills-<?php echo e($category->slug); ?>" aria-selected="true"><?php echo e($category->name); ?></a>
                        </li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </ul>

                <div class="tab-content text-left">
                    <div class="tab-pane fade show active" id="pills-<?php echo e($category->slug); ?>" role="tabpanel" aria-labelledby="pills-<?php echo e($category->slug); ?>-tab">
                        <div class="row">
                            <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-md-6 site-animate">
                                    <div class="media menu-item" id="<?php echo e($item->category->slug); ?>">
                                    <img class="mr-3" src="<?php echo e(asset('uploads/item/'.$item->image)); ?>" class="img-responsive" alt="Item" style="height: 100px; width: 100px;">
                                        <div class="media-body">
                                            <h5 class="mt-0"><?php echo e($item->name); ?></h5>
                                            <p><?php echo e($item->description); ?></p>
                                            <h6 class="text-primary menu-price"><?php echo e($item->price); ?></h6>
                                        </div>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="media d-block mb-4 text-center site-media site-animate">
                    <img src="front/images/offer_1.jpg" alt="Free Template by colorlib.com" class="img-fluid">
                    <div class="media-body p-md-5 p-4">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="media d-block mb-4 text-center site-media site-animate">
                    <img src="front/images/offer_2.jpg" alt="Free Template by colorlib.com" class="img-fluid">
                    <div class="media-body p-md-5 p-4">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="media d-block mb-4 text-center site-media site-animate">
                    <img src="front/images/offer_3.jpg" alt="Free Template by colorlib.com" class="img-fluid">
                    <div class="media-body p-md-5 p-4">
...
<section class="site-section bg-light" id="section-contact">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-1"></div>
            <div class="col-md-4 site-animate">
                <p><img src="front/images/about_img_1.jpg" alt="" class="img-fluid"></p>
                <p class="text-black">
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="bg-image" style="background-image: url(front/images/reservation_1.jpg);"></div>
                    </div>
                    <div class="col-lg-12 p-5">
                        ...
                        <form action="<?php echo e(route('reservation.reserve')); ?>" method="post">
                            <?php echo csrf_field(); ?>
                            <div class="row">
...
<script src="<?php echo e(asset('front/js/jquery.timepicker.min.js')); ?>"></script>
