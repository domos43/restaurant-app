                    ...
                    @foreach($sliders as $key=>$slider)
                        <div class="item">
                            <div class="media d-block mb-4 text-center site-media site-animate border-0">
                                <img src="{{ asset('uploads/slider/'.$slider->image) }}" alt="lobrazekjakistam" class="img-fluid" style="height: 400px; width: 400px;">
                        ...
                        <form action="{{ route('reservation.reserve') }}" method="post">
                            ...
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    ...
                                    <select name="" id="howmanypeople" class="form-control">
                            ...
                            <div class="row">
                                <div class="col-md-12 form-group">
                                    ...
                                    <textarea class="form-control" id="message" cols="30" rows="7"></textarea>
                                </div>
                            </div>
